  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="col-span-1 lg:col-span-2 bg-[var(--card)] border border-[var(--border)] shadow-sm rounded-[var(--radius-lg)] p-6">
        ...
        <div className="col-span-1 bg-[var(--card)] border border-[var(--border)] shadow-sm rounded-[var(--radius-lg)] p-6">
          <h2 className="text-xl font-semibold mb-4">Quick Actions</h2>
          <div className="space-y-3">
            <button className="w-full text-left px-4 py-3 rounded-[var(--radius-md)] bg-[var(--muted)] hover:bg-[var(--primary)] hover:text-[var(--primary-foreground)] transition-colors text-sm font-medium">
              + Add New Company
            </button>
            <button className="w-full text-left px-4 py-3 rounded-[var(--radius-md)] bg-[var(--muted)] hover:bg-[var(--primary)] hover:text-[var(--primary-foreground)] transition-colors text-sm font-medium">
...
function StatCard({ title, value, icon: Icon, trend, color }: any) {
  return (
    <div className="bg-[var(--card)] border border-[var(--border)] shadow-sm p-6 rounded-[var(--radius-lg)] flex flex-col relative overflow-hidden group">
